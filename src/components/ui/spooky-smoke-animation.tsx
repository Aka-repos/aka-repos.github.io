...
class Renderer {
  ...
  private color: [number, number, number] = [0.85, 0.85, 0.85];
  ...
  private init() {
    ...
    (program as unknown as Record<string, WebGLUniformLocation | null>).u_color = gl.getUniformLocation(program, "u_color");
  }
